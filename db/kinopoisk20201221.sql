...
--
-- Хост: localhost:3306
-- Время создания: Дек 21 2020 г., 23:37
...
--
CREATE DATABASE IF NOT EXISTS `kinopoisk` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `kinopoisk`;
...
INSERT INTO `dic_users` (`id`, `user_login`, `user_password`, `is_admin`) VALUES
