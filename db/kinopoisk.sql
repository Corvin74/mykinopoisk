...
--
CREATE DATABASE IF NOT EXISTS `kinopoisk` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `kinopoisk`;
...
CREATE TABLE IF NOT EXISTS `dic_country` (
...
DROP TABLE IF EXISTS `dic_genre`;
CREATE TABLE IF NOT EXISTS `dic_genre` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Метаданные для таблицы dic_country
--

--
-- Метаданные для таблицы dic_genre
--

--
-- Метаданные для таблицы films
--

--
-- Метаданные для базы данных kinopoisk
--
COMMIT;
